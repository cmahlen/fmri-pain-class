...
of painful heat to the lower back, from Baliki et al. 2010, *Neuron* (OpenNeuro / OpenfMRI ds000208, PDDL licence).
...
`data/` holds the raw OpenfMRI download (not shared), `derivatives/` the FSL outputs, `subjects/` the dataset metadata.
